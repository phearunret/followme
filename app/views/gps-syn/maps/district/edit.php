            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="<?php echo base_url('gps-syn/maps/district')?>"> Districts</a>
                            </li>
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="distr_nu_latitude"
                               value="<?php echo $query->distr_nu_latitude; ?>">
                        <span class="text-danger"><?php echo form_error('distr_nu_latitude'); ?></span>
                    </div>
                    <div class="form-group">
                        <label>Longitude</label>
                        <input type="text" class="form-control" name="distr_nu_longitude"
