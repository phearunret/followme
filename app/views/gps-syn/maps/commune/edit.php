            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="commu_nu_latitude"
                               value="<?php echo $query->commu_nu_latitude; ?>">
                        <span class="text-danger"><?php echo form_error('commu_nu_latitude'); ?></span>
                    </div>
                    <div class="form-group">
                        <label>Longitude</label>
                        <input type="text" class="form-control" name="commu_nu_longitude"
                               value="<?php echo $query->commu_nu_longitude; ?>">
